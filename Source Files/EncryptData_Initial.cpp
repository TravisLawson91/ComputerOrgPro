...
int encryptData(char *data, int dataLength)
{
	...
	__asm {
		...
		// lea edx, gptrPasswordHash	// starting address of password hash
		...
		// lea edx, gptrPasswordHash	// getting address of pwHash; probably redundant
		lea edx, gPasswordHash
		...
		jle INDEX_NOT_GREATER	// make jump if less than
